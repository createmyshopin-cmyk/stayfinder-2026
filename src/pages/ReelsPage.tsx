...
function VerticalReelCard({ reel }: VerticalReelCardProps) {
  ...
  return (
    ...
    >
      ...
      {/* Bottom overlay: stay name + View Stay button */}
      <div className="absolute bottom-0 left-0 right-0 p-4 pb-24 bg-gradient-to-t from-black/80 to-transparent z-10">
        ...
        <button
          ...
          className="flex items-center gap-2 w-full justify-center py-2.5 px-4 rounded-xl bg-primary text-primary-foreground font-semibold text-sm"
        >
