      ...
      if (booking) {
        ...
        if (invoiceId) {
          toast({
            ...
            action: (
              <ToastAction altText="View Invoice" onClick={() => navigate("/admin/invoices")}>
                View Invoice
              </ToastAction>
            ),
          });
      ...
      {!loading && filtered.length > 0 && (
        <div className="flex items-center gap-2">
          <button className="shrink-0" onClick={toggleSelectAll}>
            <Checkbox checked={allFilteredSelected && filtered.length > 0} />
          </button>
          ...
          return (
            ...
            >
              ...
              <div className="p-3 pb-2 flex items-start gap-2 cursor-pointer" onClick={() => setSelected(b)}>
                <button className="mt-0.5 shrink-0" onClick={(e) => { e.stopPropagation(); toggleSelect(b.id); }}>
