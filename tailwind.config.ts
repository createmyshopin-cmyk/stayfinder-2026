  ...
  theme: {
    ...
    extend: {
      ...
      colors: {
        ...
        "price-low": "hsl(var(--price-low))",
        "price-mid": "hsl(var(--price-mid))",
        "price-high": "hsl(var(--price-high))",
        "price-unavailable": "hsl(var(--price-unavailable))",
        savings: {
      ...
      keyframes: {
        ...
        "placeholder-cycle": {
          ...
          "25%, 45%": { opacity: "0", transform: "translateY(-8px)" },
